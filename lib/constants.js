// Business constants for Combat International
export const BUSINESS_INFO = {
    name: 'Combat International',
    ...
    contact: {
        ...
        email: 'combatinternational28@gmail.com',
        whatsapp: '+92-333-5101981',
        address: {
            street: 'Bahria Town Phase 7',
            area: '',
            city: 'Rawalpindi',
            country: 'Pakistan',
            full: 'Bahria Town Phase 7, Rawalpindi, Pakistan'
        }
    },
...
export const TESTIMONIALS = [
    {
        ...
        rating: 5,
        text: 'Combat International made my dream of studying in Canada a reality. Their expert guidance throughout the application process was invaluable. Highly recommended!',
        location: 'Rawalpindi'
    },
    {
        id: 2,
    ...
    },
    {
        ...
        rating: 5,
        text: 'Excellent service! They helped me secure admission to my dream university and guided me through the entire visa process. Thank you Combat International!',
        location: 'Lahore'
    },
    {
        id: 4,
    ...
    },
    {
        ...
        rating: 5,
        text: 'Combat International helped me achieve my American dream. Their interview preparation was exceptional. Forever grateful!',
        location: 'Faisalabad'
    }
];
...
export const FAQS = [
    {
        ...
        questions: [
            {
                q: 'What makes Combat International different from other visa consultancies?',
                a: 'We have a proven track record with a 98% success rate, over 20,000 visas approved, and 15 years of experience. Our personalized approach and expert team ensure the highest chances of approval.'
            },
            {
