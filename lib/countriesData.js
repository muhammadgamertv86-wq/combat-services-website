...
export const COUNTRIES_DATA = [
    ...
    // OCEANIA - Adding Fiji
    {
        ...
        touristSpots: [
            { name: 'Yasawa Islands', description: 'Remote island paradise', image: '/images/tourist-spots/yasawa-islands.jpg' },
            { name: 'Coral Coast', description: 'Beautiful coral reefs', image: '/images/tourist-spots/coral-coast.jpg' },
            { name: 'Suva', description: 'Capital city with markets', image: '/images/tourist-spots/suva.jpg' },
            { name: 'Garden of the Sleeping Giant', description: 'Orchid garden', image: '/images/tourist-spots/garden-sleeping-giant.jpg' }
        ],
